...
# 🔧 关键修复：解决跨文件系统移动问题
# 将临时目录设置到与目标目录相同的文件系统
mkdir -p /data/file/temp
export TMPDIR=/data/file/temp
export TMP=/data/file/temp
export TEMP=/data/file/temp
echo "✅ Set temporary directories to /data/file/temp to fix cross-filesystem move issues"
...
echo "Services include: MongoDB + Hydro + Judge + Sandbox"
